...
class SimpleCNN(nn.Module):
    def __init__(self, numChannels, classes = 8):
        ...
        self.fc1 = nn.Linear(in_features=51700, out_features=5000)
        self.relu3 = nn.ReLU()
...
class CNNLSTM(nn.Module):
    def __init__(self, numChannels, classes = 8):
        ...
        self.fc_cnn1 = nn.Linear(in_features=18816, out_features=5000)
        # self.fc_cnn1 = nn.Linear(in_features=9216, out_features=512)
        self.batchnorm3 = nn.BatchNorm1d(5000)
        # self.fc_cnn2 = nn.Linear(in_features=5000, out_features=300)
        self.lstm = nn.LSTM(input_size=5000, hidden_size=256, num_layers=1, bidirectional=True, batch_first=False)
        self.lstm2 = nn.LSTM(input_size=512, hidden_size=128, num_layers=1, bidirectional=True)
        self.fc_lstm = nn.Linear(in_features=256, out_features=classes)
        self.relu = nn.ReLU()
